...
_lr_productions = [
  ...
  ('Spec -> Configuration Cases','Spec',2,'p_spec','cmp_trigger.py',131),
  ('Configuration -> Config LBrace String RBrace','Configuration',4,'p_configuration','cmp_trigger.py',144),
  ('Cases -> Cases Case','Cases',2,'p_cases_cases','cmp_trigger.py',331),
  ('Cases -> Case','Cases',1,'p_cases_case','cmp_trigger.py',336),
  ('Case -> TestCase CaseName CaseStart Statements CaseEnd','Case',5,'p_case','cmp_trigger.py',341),
  ('CaseName -> ID','CaseName',1,'p_case_name','cmp_trigger.py',346),
  ('CaseStart -> LBrace','CaseStart',1,'p_case_start','cmp_trigger.py',354),
  ('Statements -> Statements Statement','Statements',2,'p_statements_statements','cmp_trigger.py',369),
  ('Statements -> Statement','Statements',1,'p_statements_statement','cmp_trigger.py',374),
  ('Statement -> StatementBody Semicolon','Statement',2,'p_statement','cmp_trigger.py',379),
  ('StatementBody -> ScopedStatement','StatementBody',1,'p_statement_body_query','cmp_trigger.py',384),
  ('ScopedStatement -> Colon ScopedStatementBody','ScopedStatement',2,'p_scoped_statement_no_term','cmp_trigger.py',389),
  ('ScopedStatementBody -> Query','ScopedStatementBody',1,'p_scoped_statement_body_query','cmp_trigger.py',399),
  ('Query -> String','Query',1,'p_query','cmp_trigger.py',405),
  ('String -> NormalString','String',1,'p_string_normal','cmp_trigger.py',410),
  ('String -> RawString','String',1,'p_string_raw','cmp_trigger.py',415),
  ('ScopedStatementBody -> ResultSetQuery','ScopedStatementBody',1,'p_scoped_statement_result_set_query','cmp_trigger.py',420),
  ('ResultSetQuery -> ResultSet LParenthesis Query RParenthesis','ResultSetQuery',4,'p_result_set_query','cmp_trigger.py',425),
  ('ScopedStatement -> Async Colon ScopedStatementBody','ScopedStatement',3,'p_scoped_statement_no_term_async','cmp_trigger.py',431),
  ('ScopedStatement -> Term Colon ScopedStatementBody','ScopedStatement',3,'p_scoped_statement_with_term','cmp_trigger.py',440),
  ('Term -> ID','Term',1,'p_term','cmp_trigger.py',452),
  ('ScopedStatement -> Async Term Colon ScopedStatementBody','ScopedStatement',4,'p_scoped_statement_with_term_async','cmp_trigger.py',457),
  ('StatementBody -> Declaration','StatementBody',1,'p_statement_body_declaration','cmp_trigger.py',466),
  ('Declaration -> Terminal TermList','Declaration',2,'p_declaration','cmp_trigger.py',471),
  ('TermList -> TermList Term','TermList',2,'p_term_list_list','cmp_trigger.py',479),
  ('TermList -> Term','TermList',1,'p_term_list_term','cmp_trigger.py',484),
  ('StatementBody -> Assignment','StatementBody',1,'p_statement_body_assignment','cmp_trigger.py',489),
  ('Assignment -> Variable EqualSign Expression','Assignment',3,'p_assignment_expression','cmp_trigger.py',494),
  ('Variable -> ID','Variable',1,'p_variable_id','cmp_trigger.py',500),
  ('Variable -> Variable Point ID','Variable',3,'p_variable_member','cmp_trigger.py',505),
  ('Expression -> String','Expression',1,'p_expression_string','cmp_trigger.py',510),
  ('Expression -> Number','Expression',1,'p_expression_number','cmp_trigger.py',515),
  ('Expression -> ScopedStatement','Expression',1,'p_expression_scoped_statement','cmp_trigger.py',520),
  ('Expression -> Variable','Expression',1,'p_expression_variable','cmp_trigger.py',533),
  ('Expression -> TupleExpression','Expression',1,'p_expression_tuple','cmp_trigger.py',538),
  ('TupleExpression -> Tuple LParenthesis String RParenthesis','TupleExpression',4,'p_expression_tuple_constructor','cmp_trigger.py',543),
  ('StatementBody -> Assertion','StatementBody',1,'p_statement_body_assertion','cmp_trigger.py',551),
  ('Assertion -> ExpectEqual LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_equal','cmp_trigger.py',556),
  ('Assertion -> ExpectNotEqual LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_not_equal','cmp_trigger.py',563),
  ('Assertion -> ExpectStrEqual LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_str_equal','cmp_trigger.py',570),
  ('Assertion -> ExpectStrNotEqual LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_str_not_equal','cmp_trigger.py',577),
  ('Assertion -> ExpectSubStr LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_sub_str','cmp_trigger.py',584),
  ('Assertion -> ExpectNoSubStr LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_no_sub_str','cmp_trigger.py',591),
  ('Assertion -> ExpectIn LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_in','cmp_trigger.py',598),
  ('Assertion -> ExpectNotIn LParenthesis Expression Comma Expression RParenthesis','Assertion',6,'p_assertion_expect_not_in','cmp_trigger.py',605),
  ('StatementBody -> Shell LParenthesis String RParenthesis','StatementBody',4,'p_statement_body_shell','cmp_trigger.py',612),
  ('CaseEnd -> RBrace','CaseEnd',1,'p_case_end','cmp_trigger.py',617),
]
